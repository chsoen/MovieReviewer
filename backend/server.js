...
let query2 = {"movie": "Matchmaker Mysteries: A Fatal Romance (2020) Season 1, Episode 2"}
let query3 = {"movie": "Thappad (I) (2020)"}
...
app.get('/movies/:movie', async (req, res) => {
    ...
    console.log(movie)
    let query = {"movie": movie}
    console.log(query)
    let rating = await invokeLambda(query);
